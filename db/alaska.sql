...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 20 août 2018 à 06:50
...
(21, 'j\'adore ', 9, 3, '2018-08-08 17:59:17'),
(23, 'c\'est super, ça m \'a convaincu pour mon prochain voyage.', 6, 3, '2018-08-08 18:02:36'),
(25, 'Que du bonheur!!!', 7, 3, '2018-08-08 21:17:12'),
(55, 'Lecture très facile, j\'attends la suite...', 9, 3, '2018-08-08 14:43:34'),
(77, 'vite, vite la suite...', 7, 5, '2018-08-08 11:01:40'),
(82, '<p>Je suis impatient pour la suite..</p>', 7, 5, '2018-08-08 18:03:37'),
(83, '<p>Quand pensez-vous finir le livre, je souhaite l\'acheter au plus vite</p>', 7, 5, '2018-08-09 13:17:06'),
(87, '5eme commentaires\r\n', 7, 14, '2018-08-15 19:28:15'),
(88, '6eme commentaires\r\n', 7, 14, '2018-08-15 19:28:23'),
(89, '6eme commentaires\r\n', 7, 14, '2018-08-15 19:32:23');
...
CREATE TABLE IF NOT EXISTS `t_report` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_rep_com` (`com_id`),
  KEY `fk_rep_usr` (`usr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `t_report`
--

INSERT INTO `t_report` (`id`, `com_id`, `usr_id`, `report_date`) VALUES
(89, 77, 3, '2018-08-08 17:50:20'),
(94, 82, 5, '2018-08-13 17:03:58');
...
--
-- Contraintes pour la table `t_report`
--
ALTER TABLE `t_report`
  ADD CONSTRAINT `fk_rep_com` FOREIGN KEY (`com_id`) REFERENCES `t_comment` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_rep_usr` FOREIGN KEY (`usr_id`) REFERENCES `t_user` (`id`) ON DELETE CASCADE;
COMMIT;
